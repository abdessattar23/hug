...
#+++++++++++++++++++++++++
def getrapport(url):             
    resp = requests.get(f"https://api.microlink.io/?url={url}&insights=true&embed=insights.lighthouse")   
    return resp.text           
#+++++++++++++++++++++++++
...
- If the given information in the sections "Rapport" and "URL" are incorrect, respond only with "error".
...
- You will be given a rapport and a website URL to better analyze if the website is safe or unsafe (phishing).
